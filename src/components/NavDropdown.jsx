...
export function NavDropdown({ label, items, linkBase, itemLabel }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-1/2 top-full z-10 mt-3 w-52 -translate-x-1/2 rounded-2xl bg-white p-2 shadow-[0_16px_40px_-12px_rgba(11,92,87,0.25)] ring-1 ring-ink/10 transition-all duration-200 ${
