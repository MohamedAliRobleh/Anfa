...
export function Confirmation({ throttled }) {
  ...
  return (
    <div role="status" className="flex flex-col items-center py-6 text-center">
      ...
      <a
        href="/"
        className="mt-8 rounded-full bg-sunlit px-8 py-3 text-sm font-semibold text-ink shadow-[0_2px_10px_rgba(221,176,103,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(221,176,103,0.45)]"
      >
